...
<div class="font-group">
    ...
    <el-color-picker v-model="curFontColor" :disabled="disabledFont" @change="execCommandFontColor" size="small"></el-color-picker>
    <el-color-picker v-model="curBgFontColor" :disabled="disabledFont" @change="execCommandBgFontColor" size="small"></el-color-picker>
</div>
</template>
...
export default {
    ...
    watch:{
        selectForColor(newv,oldv){
            this.updateFontColorDefaultValue(newv)
        },
        selectBgColor(newv,oldv){
            this.updateBgColorDefaultValue(newv)
        }
    },
    computed: {
        ...mapGetters({
        ...
        selectForColor(){
            let currentForeColor =this.minder.queryCommandValue &&
            this.minder.queryCommandValue("ForeColor");
            this.updateFontColorDefaultValue(currentForeColor)
            return currentForeColor;
        },
        selectBgColor(){
            let currentBgColor =this.minder.queryCommandValue &&
                this.minder.queryCommandValue("Background");
            this.updateBgColorDefaultValue(currentBgColor)
        ...
        disabledFont() {
            ...
            this.updateFontFamilyDefaultValue(currentFontFamily)
            return (
        ...
        disabledFontSize() {
            this.updateFontSizeDefaultValue((this.minder.queryCommandValue &&
    ...
    methods: {
        updateFontColorDefaultValue(currentFontColor){
            this.curFontColor=currentFontColor||"";
        },
        updateBgColorDefaultValue(currentBgColor){
            this.curBgFontColor=currentBgColor||"";
        },
        updateFontFamilyDefaultValue(currentFontFamily){
            this.fontFamilyDefaultValue = currentFontFamily || "字体";
        },
        updateFontSizeDefaultValue(fontSizeDefaultValue){
        ...
        execCommandFontColor(color){
            this.minder.execCommand("ForeColor",color);
        },
        execCommandBgFontColor(bgColor){
            this.minder.execCommand("Background",bgColor);
        }
    },
};
</script>
