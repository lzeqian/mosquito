...
func (sam *FtpFileSystemFactory) Create()  (FileSystem,error) {
	sambahost:=beego.AppConfig.String("ftphost")
	sambaport:=beego.AppConfig.String("ftpport")
	sambauser:=beego.AppConfig.String("ftpuser")
	sambapassword:=beego.AppConfig.String("ftppassword")
