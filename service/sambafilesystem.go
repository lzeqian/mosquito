...
func (sam *SambaFileSystemFactory) Create()  (FileSystem,error) {
	sambahost:=beego.AppConfig.String("sambahost")
	sambaport:=beego.AppConfig.String("sambaport")
	sambauser:=beego.AppConfig.String("sambauser")
	sambapassword:=beego.AppConfig.String("sambapassword")
